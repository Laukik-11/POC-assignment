  ...
  return (
    <BottomSheet ref={ref}>
      <Box p={3}>
        ...
        <Box mt={2}>
          <Button sx={{ background: "black", borderRadius: "4px", border: "2px solid white" }} variant="contained" fullWidth onClick={handlePrimaryButton}>
        ...
        {hasEnumFlag(status, RouteExecutionStatus.Done) ? (
          <Box mt={2}>
            <Button sx={{background:"black", borderRadius:"4px",border:"2px solid white"}} variant="text" onClick={handleSeeDetails} fullWidth>
              {t('button.seeDetails')}
            </Button>
          </Box>
        ) : null}
